        ...
        <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white rounded-3xl p-8 sm:p-14 shadow-2xl mb-12 relative overflow-hidden border border-slate-800">
          ...
          <div className="max-w-3xl relative z-10">
            ...
            <p className="text-slate-300 text-base sm:text-lg mb-10 max-w-2xl leading-relaxed font-normal">
              Welcome to the open digital ecosystem. Whether you&apos;re drafting personal life stories, philosophical deep-dives, culinary reviews, or technical architecture guides, our real-time AI Reach Assistant polishes your structure so your voice finds its global audience.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a href="#community-feed-deck" className="btn btn-secondary text-white bg-white/5 border-slate-700 hover:border-slate-500 px-7 py-4 rounded-2xl font-extrabold text-base">
                Explore Feed &rarr;
              </a>
            </div>
          </div>
          ...
          >
            ...
            <div className="lg:w-1/2 h-72 lg:h-auto bg-cover bg-center relative overflow-hidden flex-shrink-0" style={{ backgroundImage: `url('${featuredLeader.image_url}')` }}>
              ...
              <div className="absolute bottom-4 left-4 bg-slate-950/90 text-white backdrop-blur-md px-4 py-2 rounded-2xl text-xs font-black flex items-center gap-2 border border-slate-800">
                ...
                <span>⚡ {featuredLeader.seo_score}/100 AI Readability Score</span>
              </div>
            </div>
              ...
              <div>
                <div className="flex items-center gap-3 text-xs font-bold text-slate-500 dark:text-slate-400 mb-4">
                  ...
                  <span className="text-indigo-600 dark:text-indigo-400 font-extrabold flex items-center gap-1">
                    <Eye className="w-4 h-4" /> {(featuredLeader.pageviews || 1).toLocaleString()} Genuine Hits
                  </span>
                </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-bold text-indigo-600 dark:text-indigo-400">{featuredLeader.profiles?.professional_role || 'Creator'}</div>
                  </div>
                </div>
