export const resourceCategories = [
	{
		...
		resources: [
			...
			{ name: "Grammarly", url: null, affiliate: true, badge: "Paid", why: "Premium polish for client work. Verify NPR pricing before publishing." },
			{ name: "Canva", url: null, affiliate: true, badge: "Freemium", why: "Design posts and thumbnails; free tier plus Pro affiliate. Verify NPR." },
		],
	},
	{
		id: "freelancing",
		...
		resources: [
			...
			{ name: "Notion", url: null, affiliate: true, badge: "Freemium", why: "Proposals and client wikis. Verify NPR pricing." },
		],
	},
	{
		id: "hosting",
		...
		resources: [
			{ name: "Hostinger", env: "NEXT_PUBLIC_AFFILIATE_HOSTINGER_URL", affiliate: true, badge: "Paid", why: "Primary pick; eSewa-linked cards work; LiteSpeed is fast on NTC. Verify intro and renewal NPR." },
			...
			{ name: "Namecheap", url: null, affiliate: true, badge: "Paid", why: "Domains only; keep domain separate from host. Verify NPR." },
			{ name: "WordPress.com", url: null, affiliate: true, badge: "Freemium", why: "Zero-hassle publishing for non-technical beginners. Verify NPR." },
	...
	},
	{
		...
		resources: [
			{ name: "Payoneer", url: null, affiliate: true, badge: "Freemium", why: "Receive USD and withdraw to a Nepali bank. Verify fees/limits for Sept 2026." },
			{ name: "Wise", url: null, affiliate: true, badge: "Freemium", why: "Low-fee transfers; compare against Payoneer and verify NPR rails." },
			{ name: "eSewa / Khalti", url: null, badge: "ℹ", why: "Local wallets for local client payments and linked-card hosting workflows. Verify current card-linking." },
			{ name: "Upwork direct to bank", url: null, badge: "ℹ", why: "US clients to Upwork to Nepali bank pipeline; document fees before publishing." },
		],
	},
	{
		id: "business",
		...
		resources: [
			...
			{ name: "Daraz", url: null, affiliate: true, badge: "Freemium", why: "SMB selling channel. Verify affiliate program terms." },
		],
	},
	{
		id: "students",
		...
		resources: [
			...
			{ name: "Open Library", url: "https://openlibrary.org", badge: "Free", status: "", why: "Borrow scanned books free; confirm in browser before publishing claims." },
